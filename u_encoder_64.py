...
class U_Encoder(keras.Model):
    def __init__(self, num_classes=1, activation = 'softmax'):
       ...
       # self.inputs = inputs
        ...
        #self.conv4 =  separable_conv_block(128, 0.2) # decrease layers, try max 128 and 64. 
       ...
       # self.up_conv2 = conv_transpose(64,0.1)
        ...
        self.out_layer = Conv2D(num_classes,(1,1), activation = activation) #Normal Wnet version for testing.
